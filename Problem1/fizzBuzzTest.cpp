...
// Loop from 1 to 100
    for(int i = 1; i <= 100; i++){
        if (i % 3 == 0 && i % 5 == 0) { // for multiples of three and five
            fizzbuzzResult[i-1] = "FizzBuzz";   
        }
        else if (i % 5 == 0) { // for multiples of five
            fizzbuzzResult[i-1] = "Buzz";
        }
        else if (i % 3 == 0) { // for multiples of three
            fizzbuzzResult[i-1] = "Fizz";
        }
        else { // for non-multiples of three or five
